...
import { changeClickedChampion } from "../store/ClickedChampionReducer";
            ...
            <ThemeProvider theme={imageCardTheme}>
                <Card
                    ...
                    onClick={() => {
                        ...
                        dispatch(changeClickedChampion(champion));
                        sessionStorage.setItem("clickedChampion", champion.id);
                    }}
                >
                    <CardActionArea>
                        <CardMedia
